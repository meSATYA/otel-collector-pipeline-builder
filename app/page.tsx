...
const data = {
  ...
  processors: ["adaptivetailsamplingprocessor","attributesprocessor","awsecsattributesprocessor","cardinalityguardianprocessor","coralogixprocessor","cumulativetodeltaprocessor","deltatocumulativeprocessor","deltatorateprocessor","drainprocessor","filterprocessor","genainormalizerprocessor","geoipprocessor","groupbyattrsprocessor","groupbytraceprocessor","intervalprocessor","isolationforestprocessor","k8sattributesprocessor","logdedupprocessor","logstransformprocessor","lookupprocessor","metricsgenerationprocessor","metricstarttimeprocessor","metricstransformprocessor","probabilisticsamplerprocessor","redactionprocessor","remotetapprocessor","resourcedetectionprocessor","resourceprocessor","schemaprocessor","signingprocessor","spanprocessor","spanpruningprocessor","sumologicprocessor","tailsamplingprocessor","transformprocessor","unrollprocessor"],
